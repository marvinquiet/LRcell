---
title: "LRcell: Identification of cell-type enrichment in bulk RNA-seq datasets leveraging scRNA-seq marker genes information"
...
package: LRcell
abstract: >
  This vignette introduces the use of LRcell, which is designed to use cell markers
  acquired from single-cell RNA-sequecing (scRNA-seq) as information to identify 
  certain cell types with the most transcriptional engagement in bulk experiments.
  LRcell contains 3 major components: LRcell analysis, plot generation and marker
  gene selection. All modules in this package are written in R. This package also 
  provides marker genes in 1 human brain region (Prefrontal Cortex) and 9 mouse 
  brain regions (Frontal Cortex, Cerebellum, Globus Pallidus, Hippocampus, 
  Entopeduncular, Posterior Cortex, Striatum, Substantia Nigra and Thalamus).
output:
...
marker genes to do analysis on the example bulk experiment. (The example contains 23, 420 genes along with p-values calculated from 
...
### Marker gene download and do LRcell
...
The calculation is based on this [science paper](https://science.sciencemag.org/content/352/6291/1326.long)
...
This random example contains 3 genes and 10 cells. As you can tell from the matrix, __gene1__ is 
