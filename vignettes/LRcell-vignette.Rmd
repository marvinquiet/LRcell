---
title: "LRcell: Differential **cell** type change analysis using **L**inear/**L**ogistic **R**egression."
...
abstract: >
  ...
  LRcell is inspired by the LRpath[@sartor2009lrpath] algorithm developed by Sartor et al., originally designed for 
  pathway/gene set enrichment analysis. LRcell contains three major components: 
  LRcell analysis, plot generation and marker gene selection. All modules in this package are written in R. 
  This package also provides marker genes in the Prefrontal Cortex (pFC) human brain region and 
...
The data comes from mouse brain single-cell RNA-seq experiments[@saunders2018molecular]. 
